    ...
    def __init__(
        ...
        if self.agent_state.message_ids is not None:
            ...
            if initial_message_sequence is not None:
                ...
                for i,m in enumerate(initial_message_sequence):
                    if "user_id" not in m:
                        initial_message_sequence[i].user_id = self.agent_state.user_id
                    if "agent_id" not in m:
                        initial_message_sequence[i].agent_id = self.agent_state.id
